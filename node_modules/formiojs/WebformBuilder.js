  ...
  _createClass(WebformBuilder, [{
    ...
    value: function updateComponent(component, changed) {
      ...
      if (defaultValueComponent && !defaultChanged) {
        _lodash.default.assign(defaultValueComponent.component, _lodash.default.omit(component, ['key', 'label', 'placeholder', 'tooltip', 'hidden', 'autofocus', 'validate', 'disabled', 'defaultValue', 'customDefaultValue', 'calculateValue']));
