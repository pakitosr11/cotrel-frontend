(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/common'), require('@angular/core'), require('@angular/material'), require('lodash.clonedeep'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/common', '@angular/core', '@angular/material', 'lodash.clonedeep', 'rxjs'], factory) :
    (factory((global.ng = global.ng || {}, global.ng['angular4-material-table'] = {}),global.ng.common,global.ng.core,null,global.index,null));
}(this, (function (exports,common,core,material,cloneDeep,rxjs) { 'use strict';
    ...
    var DefaultValidatorService = /** @class */ (function () {
        ...
        DefaultValidatorService = __decorate$2([
            core.Injectable()
