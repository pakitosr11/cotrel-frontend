(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('lodash'), require('formiojs'), require('rxjs'), require('native-promise-only'), require('@angular/router'), require('@angular/common'), require('@angular/forms'), require('ngx-bootstrap/pagination')) :
    typeof define === 'function' && define.amd ? define('index', ['exports', '@angular/core', 'lodash', 'formiojs', 'rxjs', 'native-promise-only', '@angular/router', '@angular/common', '@angular/forms', 'ngx-bootstrap/pagination'], factory) :
    (global = global || self, factory(global['formio-resource'] = {}, global.i0, global._, global.formiojs, global.rxjs, global.Promise$1, global.router, global.common, global.forms, global.pagination));
}(this, (function (exports, i0, _, formiojs, rxjs, Promise$1, router, common, forms, pagination) { 'use strict';
    ...
    var FormioResourceService = /** @class */ (function () {
        ...
        FormioResourceService.ctorParameters = function () { return [
            ...
            { type: FormioLoader },
            { type: FormioResources, decorators: [{ type: i0.Optional }] }
        ]; };
