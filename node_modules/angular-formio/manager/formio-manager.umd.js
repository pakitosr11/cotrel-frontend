(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('formiojs'), require('lodash'), require('lodash/each'), require('lodash/intersection'), require('@angular/router'), require('rxjs'), require('ngx-bootstrap/modal'), require('@angular/common'), require('@angular/forms'), require('ngx-bootstrap/pagination')) :
    typeof define === 'function' && define.amd ? define('index', ['exports', '@angular/core', 'formiojs', 'lodash', 'lodash/each', 'lodash/intersection', '@angular/router', 'rxjs', 'ngx-bootstrap/modal', '@angular/common', '@angular/forms', 'ngx-bootstrap/pagination'], factory) :
    (global = global || self, factory(global['formio-manager'] = {}, global.i0, global.formiojs, global._, global._each, global._intersection, global.router, global.rxjs, global.modal, global.common, global.forms, global.pagination));
}(this, (function (exports, i0, formiojs, _, _each, _intersection, router, rxjs, modal, common, forms, pagination) { 'use strict';
    ...
    var FormioGridComponent = /** @class */ (function () {
        ...
        FormioGridComponent.propDecorators = {
            src: [{ type: i0.Input }],
            items: [{ type: i0.Input }],
            onForm: [{ type: i0.Input }],
            query: [{ type: i0.Input }],
            refresh: [{ type: i0.Input }],
            gridType: [{ type: i0.Input }],
            size: [{ type: i0.Input }],
            components: [{ type: i0.Input }],
            formio: [{ type: i0.Input }],
            createText: [{ type: i0.Input }],
            isActionAllowed: [{ type: i0.Input }],
            select: [{ type: i0.Output }],
            rowSelect: [{ type: i0.Output }],
            rowAction: [{ type: i0.Output }],
            createItem: [{ type: i0.Output }],
            error: [{ type: i0.Output }],
            headerElement: [{ type: i0.ViewChild, args: ['headerTemplate', { read: i0.ViewContainerRef, static: true },] }],
            bodyElement: [{ type: i0.ViewChild, args: ['bodyTemplate', { read: i0.ViewContainerRef, static: true },] }],
            footerElement: [{ type: i0.ViewChild, args: ['footerTemplate', { read: i0.ViewContainerRef, static: true },] }]
        };
    ...
    var FormManagerIndexComponent = /** @class */ (function () {
        ...
        FormManagerIndexComponent.propDecorators = {
            formGrid: [{ type: i0.ViewChild, args: [FormioGridComponent, { static: false },] }]
        };
    ...
    var FormBuilderComponent = /** @class */ (function () {
        ...
        FormBuilderComponent.ctorParameters = function () { return [
            { type: i0.NgZone },
            { type: FormioAppConfig, decorators: [{ type: i0.Optional }] },
            { type: CustomTagsService, decorators: [{ type: i0.Optional }] }
        ]; };
        FormBuilderComponent.propDecorators = {
            form: [{ type: i0.Input }],
            options: [{ type: i0.Input }],
            formbuilder: [{ type: i0.Input }],
            noeval: [{ type: i0.Input }],
            refresh: [{ type: i0.Input }],
            change: [{ type: i0.Output }],
            builderElement: [{ type: i0.ViewChild, args: ['builder', { static: true },] }]
        };
    ...
    var FormManagerEditComponent = /** @class */ (function () {
        ...
        FormManagerEditComponent.propDecorators = {
            builder: [{ type: i0.ViewChild, args: [FormBuilderComponent, { static: false },] }],
            formTitle: [{ type: i0.ViewChild, args: ['title', { static: false },] }],
            formType: [{ type: i0.ViewChild, args: ['type', { static: false },] }]
        };
    ...
    var FormioBaseComponent = /** @class */ (function () {
        ...
        FormioBaseComponent.propDecorators = {
            form: [{ type: i0.Input }],
            submission: [{ type: i0.Input }],
            src: [{ type: i0.Input }],
            url: [{ type: i0.Input }],
            service: [{ type: i0.Input }],
            options: [{ type: i0.Input }],
            formioOptions: [{ type: i0.Input }],
            renderOptions: [{ type: i0.Input }],
            readOnly: [{ type: i0.Input }],
            viewOnly: [{ type: i0.Input }],
            hideComponents: [{ type: i0.Input }],
            refresh: [{ type: i0.Input }],
            error: [{ type: i0.Input }],
            ...
            customEvent: [{ type: i0.Output }],
            submit: [{ type: i0.Output }],
            prevPage: [{ type: i0.Output }],
            nextPage: [{ type: i0.Output }],
            beforeSubmit: [{ type: i0.Output }],
            change: [{ type: i0.Output }],
            invalid: [{ type: i0.Output }],
            errorChange: [{ type: i0.Output }],
            formLoad: [{ type: i0.Output }],
            submissionLoad: [{ type: i0.Output }],
            ready: [{ type: i0.Output }],
            formioElement: [{ type: i0.ViewChild, args: ['formio', { static: true },] }]
        };
    ...
    var FormioComponent = /** @class */ (function (_super) {
        __extends$7(FormioComponent, _super);
