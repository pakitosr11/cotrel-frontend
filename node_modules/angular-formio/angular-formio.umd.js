(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('formiojs'), require('@angular/router'), require('lodash'), require('@angular/elements'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('index', ['exports', '@angular/core', 'rxjs', 'formiojs', '@angular/router', 'lodash', '@angular/elements', '@angular/common'], factory) :
    (global = global || self, factory(global['angular-formio'] = {}, global.i0, global.rxjs, global.formiojs, global.router, global.lodash, global.elements, global.common));
}(this, (function (exports, i0, rxjs, formiojs, router, lodash, elements, common) { 'use strict';
